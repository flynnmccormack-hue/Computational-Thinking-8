...
print("Ok, {book} is a pretty good book, but I am reading a book on anti-gravity!")
...
print(f"Oh {college}, that's a pretty nice place, well get good grades, stay out of trouble, and lock in, good bye!")
print (r"######## ##       ##    ## ##    ## ##    ##")
print (r"##       ##        ##  ##  ###   ## ###   ##")
print (r"##       ##         ####   ####  ## ####  ##") 
print (r"######   ##          ##    ## ## ## ## ## ##")
